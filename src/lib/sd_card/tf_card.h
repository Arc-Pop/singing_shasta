...
/* SPI pin assignment */
#define PIN_SPI0_MISO_DEFAULT   16   // 0, 4, 16
#define PIN_SPI0_CS_DEFAULT     17   // 1, 5, 17
#define PIN_SPI0_SCK_DEFAULT    18   // 2, 6, 18
#define PIN_SPI0_MOSI_DEFAULT   19   // 3, 7, 19

#define PIN_SPI1_MISO_DEFAULT   12   //  8, 12
#define PIN_SPI1_CS_DEFAULT     13   //  9, 13
#define PIN_SPI1_SCK_DEFAULT    14  // 10, 14
#define PIN_SPI1_MOSI_DEFAULT   15  // 11, 15
